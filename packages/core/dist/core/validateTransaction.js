...
async function validateTransaction(connection, transaction, feePayer, maxSignatures, lamportsPerSignature) {
    ...
    return { signature: bs58_1.default.encode(transaction.signature), rawTransaction };
}
